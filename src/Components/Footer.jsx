    ...
    <section className='bg-font-color/75' >
        <div className="container">
            <div className=' pt-10 flex items-center ' >
                <div className='w-1/3'>
                    <ul className='text-[#FFFFFF]  font-inter font-light text-md ' >
                        <li>Contuct us</li>
                        <li className='mt-3 mb-3' >About us</li>
                        <li className='mt-3 mb-3' >Report review</li>
                        <li>Blog</li>
                    </ul>
                </div>
                <div className='w-2/3'>
                   <ul className='flex gap-10'>
                    ...
                    <li className="w-12 h-12 bg-gray-200 text-2xl rounded-full text-primary_white items-center flex justify-center  hover:bg-secondary_color" ><FaInstagramSquare className='text-3xl' /></li>
                      ...
                      <div className='flex items-center py-8 gap-x-3'>
                                 <form className="w-[300px] ">
                                   ...
                                   <div className="relative ">
                                     ...
                                     <input
                                       type="search"
                                       id="default-search"
                                       className="block w-full p-3  ps-13 text-base text-font-color border border-black/60 rounded-lg bg-card-bg  "
                                  ...
                                  <button type="button" class="text-font-color   bg-card-bg font-light font-inter rounded-md text-md px-9 py-3 ">subscribe</button>
                               </div>
                </div>
            </div>
